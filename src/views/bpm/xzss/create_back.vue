      ...
      <ContentWrap title="创建行政诉讼">
        ...
        >
          ...
          <el-form-item label="执行情况" prop="xzssKz.zxQk">
            <el-input v-model="formData.xzssKz.zxQk" placeholder="请输入执行情况" type="textarea" />
          </el-form-item>
          ...
          <el-row>
            <el-col :span="8">
              <el-form-item label="是否装订" prop="xzssKz.zdQk">
                <el-select v-model="formData.xzssKz.zdQk" placeholder="请选择" style="width: 100%">
          ...
          <el-row>
            <el-col :span="8">
              <el-form-item label="是否移交" prop="xzssKz.yjQk">
                <el-select v-model="formData.xzssKz.yjQk" placeholder="请选择" style="width: 100%">
                  <el-option label="是" :value="1" />
                  <el-option label="否" :value="0" />
                </el-select>
              </el-form-item>
