<template>
  <el-descriptions :column="2" border style="margin-right: 20px" size="large">
    ...
    <el-descriptions-item label="上传附件" label-align="center" align="center" width="150px">
      {{ detailData.totalTs }}
    </el-descriptions-item>
    <el-descriptions-item
      label="请假事由"
...
import * as ReceiveApi from '@/api/bpm/receivedoc'
import { useUserStore } from '@/store/modules/user'
defineOptions({ name: 'ReceiveDetail' })
...
const getInfo = async () => {
  ...
  try {
    detailData.value = await ReceiveApi.ReceiveDocApi.getReceiveDoc(props.id || queryId)
