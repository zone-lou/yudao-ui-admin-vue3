<template>
  <el-row :gutter="20">
    <el-col :span="24">
      <ContentWrap title="创建请假申请" :bodyStyle="{ background: '#ffffff', minHeight: 'calc(100vh - 120px)' }">
        <template #header>
          ...
          >
            <table class="oa-table">
              ...
              <tbody>
                ...
                <tr>
                  <td class="label-cell"><span class="text-red-500 mr-5px">*</span>请假开始 从</td>
                  <td class="input-cell">
                ...
                <tr>
                  <td class="label-cell"><span class="text-red-500 mr-5px">*</span>请假结束 至</td>
                  <td class="input-cell">
...
watch(
  () => [formData.value.qxjStartDate, formData.value.qxjEndDate, formData.value.startPeriod, formData.value.endPeriod, formData.value.qxjType],
  () => {
    calculateDuration()
  }
)
